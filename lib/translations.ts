...
export const translations = {
  en: {
    ...
    practicesSubtitle: 'Gentle tools for mood awareness',
  ...
  'pt-BR': {
    ...
    practicesSubtitle: 'Ferramentas suaves para consciência emocional',
  ...
  fr: {
    ...
    practicesSubtitle: 'Outils doux pour la conscience émotionnelle',
  ...
  de: {
    ...
    practicesSubtitle: 'Sanfte Werkzeuge für emotionale Achtsamkeit',
  ...
  hi: {
    ...
    practicesSubtitle: 'भावनात्मक जागरूकता के लिए कोमल उपकरण',
  ...
  id: {
    ...
    practicesSubtitle: 'Alat lembut untuk kesadaran emosional',
  ...
  tr: {
    ...
    practicesSubtitle: 'Duygusal farkındalık için nazik araçlar',
  ...
  ar: {
    ...
    practicesSubtitle: 'أدوات لطيفة للتوعية العاطفية',
  ...
  ru: {
    ...
    practicesSubtitle: 'Нежные инструменты для эмоциональной осознанности',
